...
**※2023/07/09追記**
**現在では Event という名にサービス名が変わっており、この記事の内容はかなり古くなっていそうです（[後述追記](#追記20230709時点のサービス)も参照）**

**※2024/02/11追記**
**さらに IntegrationOS というサービス名に変わったっぽい？（[後述追記](#追記20240211時点のサービス)も参照）**
...
<ImageWrapper className="w-[70%]" src="screenshots/2021/buildable-introduction/pricing.png" alt="Buildable - 料金プラン画像" />
...
<ImageWrapper src="screenshots/2021/buildable-introduction/recipe.png" alt="Buildable - レシピ作成画面画像" />
...
```
<ImageWrapper src="screenshots/2021/buildable-introduction/catalog.png" alt="Buildable - カタログ画面画像" />
...
ダッシュボード画面はこんな感じ。
<ImageWrapper src="screenshots/2021/buildable-introduction/services.png" alt="Buildable - サービス画面画像" />
...
デフォルトデータベース画面
<ImageWrapper src="screenshots/2021/buildable-introduction/services-database.png" alt="Buildable - デフォルトデータベース画面画像" />
...
<ImageWrapper src="screenshots/2021/buildable-introduction/services-database-data.png" alt="Buildable - デフォルトデータベース・key のデータ画面画像" />
...
コミュニティ画面
<ImageWrapper src="screenshots/2021/buildable-introduction/community.png" alt="Buildable - コミュニティ画面画像" />
...
## 追記：2024/02/11時点のサービス
その後、2023/08くらいに IntegrationOS というサービスに変わったっぽかったです。
以下のサイトへリダイレクトされるようになっていました。
<OG url="https://www.integrationos.com" />

X も以前のアカウントは削除されており、新しくなっていました。
[@integrationos](https://twitter.com/integrationos)

サービスとしても正式リリースされているみたいですね。
