...
※2023/06/24 MUI の更新に伴い、MUI v5.0系のドキュメント参照したほうが良い部分はリンクを差し替えました。
...
<img src="/screenshots/2021/material-ui-v5/material-ui-new-logo.png" width="70%" alt="Material UI - ロゴの比較画像" />
（画像は公式ブログ記事より）
...
公式に比較表がありました。
<img src="/screenshots/2021/material-ui-v5/sx-props-performance.png" width="90%" alt="MUI - sx props のパフォーマンス比較画像" />
...
<img src="/screenshots/2021/material-ui-v5/global-class-v4.png" width="100%" alt="v4でのグローバルクラスカスタマイズで適用されるCSS（Dev Tools）画像" />

v5 のやり方で適用される CSS
<img src="/screenshots/2021/material-ui-v5/global-class-v5.png" width="100%" alt="v5でのグローバルクラスカスタマイズで適用されるCSS（Dev Tools）画像" />
...
<img src="/gifs/2021/material-ui-v5/loading-button.gif" width="70%" alt="LoadingButtonコンポーネントのプレビューGIF" />
...
<img src="/screenshots/2021/material-ui-v5/masonry.png" width="80%" alt="Masonry、MasonryItemコンポーネントのプレビュー画像" />
