...
<ImageWrapper class="w-[70%]" src="screenshots/2021/material-ui-v5/material-ui-new-logo.png" alt="Material UI - ロゴの比較画像" />
（画像は公式ブログ記事より）
...
公式に比較表がありました。
<ImageWrapper class="w-[90%]" src="screenshots/2021/material-ui-v5/sx-props-performance.png" alt="MUI - sx props のパフォーマンス比較画像" />
...
<ImageWrapper class="w-[70%]" src="gifs/2021/material-ui-v5/loading-button.gif" alt="LoadingButtonコンポーネントのプレビューGIF" />
...
<ImageWrapper class="w-[80%]" src="screenshots/2021/material-ui-v5/masonry.png" alt="Masonry、MasonryItemコンポーネントのプレビュー画像" />
