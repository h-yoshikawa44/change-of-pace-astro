...
OAuth 前のログイン画面
<ImageWrapper class="w-[80%]" src="screenshots/2021/react-query-socialite/login-before-oauth.png" alt="OAuth前のログイン画面画像 - Application logo、Application name" />

OAuth 認可画面
<ImageWrapper class="w-[80%]" src="screenshots/2021/react-query-socialite/oauth.png" alt="OAuth認可画面 - Application logo、Application name、Authorization callback URL（ドメイン部分まで）" />

Authorized OAuth Apps 画面
<ImageWrapper class="w-[80%]" src="screenshots/2021/react-query-socialite/oauth-app.png" alt="Authorized OAuth Apps画面 - Application logo、Application name、Homepage URL" />
...
ちなみにこういうやつです。
<ImageWrapper class="w-[40%]" src="screenshots/2021/react-query-socialite/social-login-error.png" alt="ログイン画面 - ソーシャルログイン失敗時アラート表示" />
