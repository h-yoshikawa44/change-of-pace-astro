...
https://socialiteproviders.com/apple-icon-180x180.png
https://socialiteproviders.com/favicon-32x32.png

## 今回作ってみたもの
<img src="/gifs/2021/react-query-socialite/github-social-login.gif" width="100%" alt="GitHubでのソーシャルログイン処理の流れのGIF" />
...
OAuth 前のログイン画面
<img src="/screenshots/2021/react-query-socialite/login-before-oauth.png" width="80%" alt="OAuth前のログイン画面画像 - Application logo、Application name" />

OAuth 認可画面
<img src="/screenshots/2021/react-query-socialite/oauth.png" width="80%" alt="OAuth認可画面 - Application logo、Application name、Authorization callback URL（ドメイン部分まで）" />

Authorized OAuth Apps 画面
<img src="/screenshots/2021/react-query-socialite/oauth-app.png" width="80%" alt="Authorized OAuth Apps画面 - Application logo、Application name、Homepage URL" />
...
ちなみにこういうやつです。
<img src="/screenshots/2021/react-query-socialite/social-login-error.png" width="40%" alt="ログイン画面 - ソーシャルログイン失敗時アラート表示" />
