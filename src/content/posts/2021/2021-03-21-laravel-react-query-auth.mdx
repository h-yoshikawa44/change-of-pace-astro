...
※2023/06/22 各種リンクの URL を tanstack.com をベースに更新しました。
...
公式の例（`useQuery`と`useMutation`）　※2023/06/22時点では TypeScript になっていました
...
<img src="/gifs/2021/laravel-react-query-auth/email-login.gif" width="100%" alt="ログイン画面でログインする流れのGIF" />
...
```
ちなみにこういうやつです。
<img src="/screenshots/2021/laravel-react-query-auth/login-alert.png" width="40%" alt="ログイン画面でのアラート表示画像" />
