...
自分のワークスペースのサイドバー
<ImageWrapper class="w-[30%]" src="screenshots/2020/notion-introduction/notion-sidebar.png" alt="Notion 自分のワークスペースのサイドバー表示" />
...
簡単な例
<ImageWrapper class="w-[80%]" src="screenshots/2020/notion-introduction/notion-page-block.png" alt="Notion ページとブロックの図" />
...
**Table**
<ImageWrapper class="w-[80%]" src="screenshots/2020/notion-introduction/notion-table.png" alt="Notion Table表示の例" />

**Board**
<ImageWrapper class="w-[80%]" src="screenshots/2020/notion-introduction/notion-board.png" alt="Notion Board表示の例" />

**List**
<ImageWrapper class="w-[80%]" src="screenshots/2020/notion-introduction/notion-list.png" alt="Notion List表示の例" />

**Calendar**
<ImageWrapper class="w-[80%]" src="screenshots/2020/notion-introduction/notion-calendar.png" alt="Notion Calendar表示の例" />

**Gallery**
<ImageWrapper class="w-[80%]" src="screenshots/2020/notion-introduction/notion-gallery.png" alt="Notion Gallery表示の例" />

**Timeline**
<ImageWrapper class="w-[80%]" src="screenshots/2020/notion-introduction/notion-timeline.png" alt="Notion Timeline表示の例" />
...
<ImageWrapper class="w-[80%]" src="screenshots/2020/notion-introduction/dashboard.png" alt="Notion 日々の記録ページ" />
...
### ドキュメント下書き・メモ
<ImageWrapper class="w-[80%]" src="screenshots/2020/notion-introduction/draft.png" alt="Notion ドキュメント下書き・メモページ" />
...
### 参考書一覧
持っている本のページ
<ImageWrapper class="w-[80%]" src="screenshots/2020/notion-introduction/books.png" alt="Notion 持っている本ページ" />
...
### リンク集
リンク集の一部抜粋
<ImageWrapper class="w-[80%]" src="screenshots/2020/notion-introduction/links-example.png" alt="Notion リンク集ページ一部抜粋" />
