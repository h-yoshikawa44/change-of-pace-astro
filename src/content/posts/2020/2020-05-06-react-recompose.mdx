...
<ImageWrapper class="w-[60%]" src="gifs/2020/react-recompose/state-counter.gif" alt="withStateを使用したカウンターのGIF" />
...
<ImageWrapper class="w-[60%]" src="screenshots/2020/react-recompose/map-props.png" alt="mapPropsを使ったサンプル画像" />
...
<ImageWrapper class="w-[60%]" src="screenshots/2020/react-recompose/with-props.png" alt="withPropsを使ったサンプル画像" />
...
<ImageWrapper class="w-[60%]" src="screenshots/2020/react-recompose/with-props-on-change-no-props.png" alt="withPropsOnChangeを使って、propsを指定しなかった場合のサンプル画像" />

props に`num`を指定した場合
<ImageWrapper class="w-[60%]" src="screenshots/2020/react-recompose/with-props-on-change.png" alt="withPropsOnChangeを使って、propsを指定した場合のサンプル画像" />
...
export default Component;
```
<ImageWrapper class="w-[60%]" src="screenshots/2020/react-recompose/default-props.png" alt="defaultPropsを使ったサンプル画像" />
...
export default Component;
```
<ImageWrapper class="w-[60%]" src="screenshots/2020/react-recompose/rename-prop.png" alt="renamePropを使ったサンプル画像" />
...
export default Component;
```
<ImageWrapper class="w-[60%]" src="screenshots/2020/react-recompose/rename-props.png" alt="renamePropsを使ったサンプル画像" />
...
export default Component;
```
<ImageWrapper class="w-[60%]" src="screenshots/2020/react-recompose/flatten-prop.png" alt="flattenPropを使ったサンプル画像" />
...
export default ComposeComponent;
```
<ImageWrapper class="w-[60%]" src="gifs/2020/react-recompose/state-handlers-counter.gif" alt="withStateHandlersを使用したカウンターのGIF" />
...
<ImageWrapper class="w-[60%]" src="screenshots/2020/react-recompose/lifecycle.png" alt="lifecycleを使用したサンプル画像" />
