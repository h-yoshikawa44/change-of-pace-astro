...
画面側
<ImageWrapper class="w-[60%]" src="screenshots/2020/docusaurus-ver-2/sidebar.png" alt="サイドバー" />
...
画面側
<ImageWrapper class="w-[50%]" src="screenshots/2020/docusaurus-ver-2/sidebar-subcategory.png" alt="階層構造にしたサイドバー" />
...
ビルド・デプロイの設定例
<ImageWrapper class="w-[80%]" src="screenshots/2020/docusaurus-ver-2/docusaurus-netlify.png" alt="Netlifyのビルド設定" />
