...
<OG url="https://crieit.net/dashboard" />
...
<ImageWrapper class="w-[80%]" src="gifs/2020/web1week-like/puzzle-overview.gif" alt="パズルのプレイ画面GIF" />

### なんでパズル？
<OG url="https://crieit.net/boards/web1week-202005/41152da9fccdaae73e45967feced2e2a" />
...
### ストップウォッチ
<ImageWrapper class="w-[50%]" src="screenshots/2020/web1week-like/stopwatch.png" alt="パズル画面のストップウォッチ部分画像" />
...
### パズル
<ImageWrapper class="w-[80%]" src="screenshots/2020/web1week-like/puzzle.png" alt="パズル画面のパズル部分画像" />
...
<ImageWrapper class="w-[60%]" src="screenshots/2020/web1week-like/konva-tree.png" alt="Konva.jsの構造画像" />
