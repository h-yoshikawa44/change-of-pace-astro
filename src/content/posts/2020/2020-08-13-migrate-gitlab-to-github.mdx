...
移行先
<img src="/screenshots/2020/migrate-gitlab-to-github/convert-issue.png" width="100%" alt="移行先のGitHub Issue詳細画面" />
...
<img src="/screenshots/2020/migrate-gitlab-to-github/convert-replacement-issue.png" width="100%" alt="移行先のGitHub （代替）Issue詳細画面" />
...
移行元
<img src="/screenshots/2020/migrate-gitlab-to-github/convert-merge-request-to-issue-before.png" width="100%" alt="移行元のGitLab マージ済みマジリク一覧画面" />

移行先
<img src="/screenshots/2020/migrate-gitlab-to-github/convert-merge-request-to-issue-after.png" width="100%" alt="移行先のGitHub 変換されたクローズ済みIssue一覧画面" />

<img src="/screenshots/2020/migrate-gitlab-to-github/convert-merge-request-to-issue-info.png" width="100%" alt="移行先のGitHub 変換されたクローズ済みIssue詳細画面" />
...
<img src="/screenshots/2020/migrate-gitlab-to-github/access-token-gitlab.png" width="100%" alt="GitLabでのアクセストークン設定画面" />
...
<img src="/screenshots/2020/migrate-gitlab-to-github/access-token-github.png" width="100%" alt="GitHubでのアクセストークン設定画面" />
