...
成功
<ImageWrapper class="w-[80%]" src="screenshots/2020/github-actions-react/github-actions-slack-success.png" alt="ワークフロー成功時のSlack通知" />

キャンセル
<ImageWrapper class="w-[80%]" src="screenshots/2020/github-actions-react/github-actions-slack-canceled.png" alt="ワークフローキャンセル時のSlack通知" />

失敗
<ImageWrapper class="w-[80%]" src="screenshots/2020/github-actions-react/github-actions-slack-failed.png" alt="ワークフロー失敗時のSlack通知" />

また、プルリクを出した時、そのリクエスト元ブランチのワークフロー実行状況が表示されるようになります。
<ImageWrapper class="w-[80%]" src="screenshots/2020/github-actions-react/pull-request.png" alt="ワークフロー実行ブランチでのプルリクエスト" />
