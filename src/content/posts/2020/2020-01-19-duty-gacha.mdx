...
以下のように設定しておきます。
<ImageWrapper class="w-[80%]" src="screenshots/2020/duty-gacha/gacha-select.png" alt="メンバー表のデータの入力規則設定" />
...
<ImageWrapper class="w-[50%]" src="screenshots/2020/duty-gacha/slack-profile.png" alt="Slackアカウントのプロフィール画面" />
...
<ImageWrapper class="w-[70%]" src="screenshots/2020/duty-gacha/gas-run-account1.png" alt="アクセス権の許可確認モーダル１" />

<ImageWrapper class="w-[70%]" src="screenshots/2020/duty-gacha/gas-run-account2.png" alt="アクセス権の許可確認モーダル２" />
...
<ImageWrapper class="w-[70%]" src="screenshots/2020/duty-gacha/result-gacha.png" alt="Slack投稿結果(新たにガチャを行った場合)" />

当番履歴表に当月の当番情報がすでにある場合は、その当月の当番がSlackに投稿されていれば OK です。
こちらは新たにスプレッドシートに書き込みは行いません。

<ImageWrapper class="w-[70%]" src="screenshots/2020/duty-gacha/result-no-gacha.png" alt="Slack投稿結果(新たにガチャを行わなかった場合)" />
