...
## 構成図
<img src="/screenshots/2020/duty-gacha/architecture.png" width="100%" alt="当番ガチャの構成図" />
...
<img src="/screenshots/2020/duty-gacha/sheet.png" width="100%" alt="用意するスプレッドシートの内容" />

#### メンバー表
ガチャ対象は〇か×で選択できるようにしておき、メンバーがガチャに参加するかどうかをここで制御できるようにします。
ガチャ対象列のデータ範囲を選択 → データ → データの入力規則
以下のように設定しておきます。
<img src="/screenshots/2020/duty-gacha/gacha-select.png" width="80%" alt="メンバー表のデータの入力規則設定" />
...
<img src="/screenshots/2020/duty-gacha/slack-profile.png" width="50%" alt="Slackアカウントのプロフィール画面" />
...
<img src="/screenshots/2020/duty-gacha/gas-run-account1.png" width="70%" alt="アクセス権の許可確認モーダル１" />

<img src="/screenshots/2020/duty-gacha/gas-run-account2.png" width="70%" alt="アクセス権の許可確認モーダル２" />
...
<img src="/screenshots/2020/duty-gacha/result-gacha.png" width="70%" alt="Slack投稿結果(新たにガチャを行った場合)" />

当番履歴表に当月の当番情報がすでにある場合は、その当月の当番がSlackに投稿されていれば OK です。
こちらは新たにスプレッドシートに書き込みは行いません。

<img src="/screenshots/2020/duty-gacha/result-no-gacha.png" width="70%" alt="Slack投稿結果(新たにガチャを行わなかった場合)" />
