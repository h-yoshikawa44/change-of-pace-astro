...
<ImageWrapper class="w-[80%]" src="screenshots/2020/domain-transfer/onamae-top.png" alt="お名前.com Navi トップ画面のドメイン一覧選択" />

2. ドメイン一覧の右上「ドメイン機能一覧」を選択
<ImageWrapper class="w-[80%]" src="screenshots/2020/domain-transfer/onamae-domain-list.png" alt="お名前.com Navi ドメイン一覧画面のドメイン機能一覧選択" />

3. ドメイン移管の「ドメイン移管ロック」を選択
<ImageWrapper class="w-[80%]" src="screenshots/2020/domain-transfer/onamae-domain-change.png" alt="お名前.com Navi ドメイン機能一覧画面のドメイン移管ロック選択" />

4. 移管ロックが OFF なことを確認（ON の場合は OFF にする）
<ImageWrapper class="w-[80%]" src="screenshots/2020/domain-transfer/onamae-domain-lock.png" alt="お名前.com Navi ドメイン移管ロック確認画面" />
...
<ImageWrapper class="w-[80%]" src="screenshots/2020/domain-transfer/onamae-domain-authcode.png" alt="お名前.com Navi ドメイン詳細画面のAuthCode表示" />
...
<ImageWrapper class="w-[80%]" src="screenshots/2020/domain-transfer/onamae-whois.png" alt="お名前.com Navi ドメイン機能一覧画面のWhois情報公開代行選択" />

{/* <!-- textlint-disable ja-technical-writing/max-kanji-continuous-len --> */}

4. 右下の「Whois 情報公開代行設定の解除はこちら」を選択
<ImageWrapper class="w-[80%]" src="screenshots/2020/domain-transfer/onamae-whois-setting.png" alt="お名前.com Navi Whois情報公開代行設定画面のWhois情報公開代行設定の解除はこちら選択" />

{/* <!-- textlint-enable --> */}

5. ドメインを選択後、解除対象に「Whois 公開代行（メール転送付き）」を選択し「確認」を選択
<ImageWrapper class="w-[80%]" src="screenshots/2020/domain-transfer/onamae-whois-setting2.png" alt="お名前.com Navi Whois情報公開代行設定解除画面の解除対象と確認選択" />
...
<ImageWrapper class="w-[80%]" src="screenshots/2020/domain-transfer/google-domain-authcode.png" alt="Google Domains ドメインの準備 ステップ2 認証コード入力" />
...
<ImageWrapper class="w-[80%]" src="screenshots/2020/domain-transfer/google-domain-setting-import.png" alt="Google Domains ウェブ設定のインポート 続行選択" />

5. 登録の設定：設定を確認して「購入手続きに進む」を選択
   デフォルトでプライバシー保護が有効になっているのは頼もしいですね。
<ImageWrapper class="w-[80%]" src="screenshots/2020/domain-transfer/google-domain-purchase.png" alt="Google Domains 登録の設定 購入手続きに進む選択" />
...
<ImageWrapper class="w-[80%]" src="screenshots/2020/domain-transfer/google-domain-mydomain.png" alt="Google Domains マイドメイン 移管ステータス確認" />
