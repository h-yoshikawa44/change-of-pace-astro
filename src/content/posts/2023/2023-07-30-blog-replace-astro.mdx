...
<img src="/screenshots/2023/blog-replace-astro/unocss-benchmark-2022-10.png" width="100%" alt="2022/10/25のベンチマーク UnoCSSを1として、windicssが6.08倍、Tailwind CSSが8.38倍" />
...
Shopify でも採用されていたりして割とメジャーなのかなと思っていたら、そもそも Shopify が作った言語じゃん…ということに執筆中に気づいたという〜😇
...
ただ、タイトルの要素が単純にコードブロックの pre 要素の前に生成されることで、後述のコピーボタンの配置と相性が悪い問題があり。
