...
<ImageWrapper class="w-[60%]" src="screenshots/2018/cleaning-duty/incoming-webhook-setting.png" alt="Slackの設定からApp管理へ行くまで" />

2. (右上の Menu → )検索へ

3. Incoming webhook で検索し、Incoming webhook を選択し、設定画面へ
<ImageWrapper class="w-[60%]" src="screenshots/2018/cleaning-duty/incoming-webhook-search.png" alt="アプリ検索画面" />
...
<ImageWrapper class="w-[80%]" src="screenshots/2018/cleaning-duty/incoming-webHook-test.png" alt="Slack投稿結果" />
