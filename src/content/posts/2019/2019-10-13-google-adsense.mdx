...
2. 申し込みフォームに必要な情報を入力
<ImageWrapper class="w-[70%]" src="screenshots/2019/google-adsense/adsense-form.png" alt="Google Adsense 申し込みフォーム" />
...
<ImageWrapper class="w-[80%]" src="screenshots/2019/google-adsense/adsense-start.png" alt="Google Adsense 有効化案内" />
...
<ImageWrapper class="w-[80%]" src="screenshots/2019/google-adsense/adsense-complete.png" alt="Google Adsense 審査通過メール" />
