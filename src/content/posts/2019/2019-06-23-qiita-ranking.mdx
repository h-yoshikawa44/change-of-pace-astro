...
下記の`App管理`から設定画面へ。
<img src="/screenshots/2019/qiita-ranking/slack.png" width="100%" alt="SlackでApp管理に行くまで" />
...
<img src="/screenshots/2019/qiita-ranking/ranking.png" width="100%" alt="Slackにランキング投稿結果" />
