...
<ImageWrapper className="w-[80%]" src="screenshots/2019/google-search-console/search-console-top.png" alt="Google Search Console トップ画面" />

2. Google アカウントにログイン

3. プロパティタイプの選択（今回は「URL プレフィックス」を選択して、サイト URL を入力して進めます）
<ImageWrapper className="w-[80%]" src="screenshots/2019/google-search-console/select-type.png" alt="プロパティタイプの選択画面" />
...
<ImageWrapper className="w-[80%]" src="screenshots/2019/google-search-console/check-domain.png" alt="所有権をGoogle Analyticsから確認した画面" />
...
<ImageWrapper className="w-[80%]" src="screenshots/2019/google-search-console/search-console-sitemap.png" alt="Google Search Consoleにサイトマップを登録" />
...
<ImageWrapper className="w-[80%]" src="screenshots/2019/google-search-console/analytics-link.png" alt="Google Analyticsと他サービスとのリンク状況" />

これで Google Analytics 側から、Google Search Console の機能が使えるようになりました。
<ImageWrapper className="w-[80%]" src="screenshots/2019/google-search-console/analytics-search-console.png" alt="Google Analytics側からGoogle Search Consoleの機能を使用" />
