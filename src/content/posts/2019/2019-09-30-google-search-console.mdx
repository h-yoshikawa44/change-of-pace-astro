...
<img src="/screenshots/2019/google-search-console/search-console-top.png" width="80%" alt="Google Search Console トップ画面" />

2. Google アカウントにログイン

3. プロパティタイプの選択（今回は「URL プレフィックス」を選択して、サイト URL を入力して進めます）
<img src="/screenshots/2019/google-search-console/select-type.png" width="80%" alt="プロパティタイプの選択画面" />
...
<img src="/screenshots/2019/google-search-console/check-domain.png" width="80%" alt="所有権をGoogle Analyticsから確認した画面" />
...
<img src="/screenshots/2019/google-search-console/search-console-sitemap.png" width="80%" alt="Google Search Consoleにサイトマップを登録" />
...
<img src="/screenshots/2019/google-search-console/analytics-link.png" width="80%" alt="Google Analyticsと他サービスとのリンク状況" />

これで Google Analytics 側から、Google Search Console の機能が使えるようになりました。
<img src="/screenshots/2019/google-search-console/analytics-search-console.png" width="80%" alt="Google Analytics側からGoogle Search Consoleの機能を使用" />
