...
<img src="/screenshots/2019/wsl-expo-network/network-error.png" width="80%" alt="ネット上のページにアクセスできないエラー画面" />
...
<img src="/screenshots/2019/wsl-expo-network/file-run.png" width="80%" alt="ファイル名を指定して実行画面" />

2. 一覧から LxssManager を見つける
<img src="/screenshots/2019/wsl-expo-network/lxss-manager.png" width="80%" alt="サービスの一覧画面" />
