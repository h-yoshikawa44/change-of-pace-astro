...
<ImageWrapper class="w-[60%]" src="screenshots/2019/wsl-expo-network/network-error.png" alt="ネット上のページにアクセスできないエラー画面" />
...
<ImageWrapper class="w-[80%]" src="screenshots/2019/wsl-expo-network/file-run.png" alt="ファイル名を指定して実行画面" />

2. 一覧から LxssManager を見つける
<ImageWrapper class="w-[80%]" src="screenshots/2019/wsl-expo-network/lxss-manager.png" alt="サービスの一覧画面" />
