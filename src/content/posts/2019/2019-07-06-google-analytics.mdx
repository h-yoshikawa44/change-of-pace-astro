...
<img src="/screenshots/2019/google-analytics/analytics.png" width="100%" alt="トラッキングコード表示画面" />
...
<img src="/screenshots/2019/google-analytics/netlify-environment.png" width="100%" alt="Netlify環境変数設定画面" />
