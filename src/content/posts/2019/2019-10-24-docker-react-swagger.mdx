...
<ImageWrapper class="w-[70%]" src="gifs/2019/docker-react-swagger/react-app.gif" alt="Reactアプリ トップ画面" />
...
<ImageWrapper class="w-[80%]" src="screenshots/2019/docker-react-swagger/swagger-api-axios.png" alt="Swaggerにaxiosでアクセスしてコンソールに出力した画面" />
