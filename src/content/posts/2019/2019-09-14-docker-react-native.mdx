...
<ImageWrapper class="w-[80%]" src="screenshots/2019/docker-react-native/expo.png" alt="Expoの公式サイト" />
...
#### Expo Client をインストール
<ImageWrapper class="w-[40%]" src="screenshots/2019/docker-react-native/expo-client.png" alt="Expo ClientのApp Store画面" />
...
しばらくするとQRコードが表示されます。
<ImageWrapper class="w-[80%]" src="screenshots/2019/docker-react-native/expo-start.png" alt="expo startの画面" />
...
<ImageWrapper class="w-[40%]" src="screenshots/2019/docker-react-native/app-guide.png" alt="Expoアプリのガイド" />
...
<ImageWrapper class="w-[40%]" src="screenshots/2019/docker-react-native/app-preview.png" alt="Expoアプリの実行画面" />
