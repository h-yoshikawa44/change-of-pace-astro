...
## v9.0.1（2026-08-04）
### Fixed
- Google Adsense の広告が表示されなくなった問題に対応(#267)

## v9.0.0（2026-08-02）
### Updated
各種パッケージのアプデ(#262)
- Node.js: 24.15.0 -> 24.18.0
...
- Astro: 5.17.1 -> 6.1.5
- UnoCSS: 66.6.0 -> 66.6.8

## v7.5.0（2026-02-17）
### Updated
各種パッケージのアプデ(#247)
- Astro: 5.16.0 -> 5.17.1
- UnoCSS: 66.5.9 -> 66.6.0

## v7.4.0（2026-01-24）
### Updated
- Node.js のアプデ: 24.11.1 -> 24.13.0(#243)

## v7.3.1（2025-11-30）
### Development Changed
- Node.js バージョン管理を mise へ移行(#233)
- GHA のセキュリティ改善(#235)

## v7.3.0（2025-11-23）
### Updated
- 各種アプデ(#224)
  - Node.js: 22.19.0 -> 24.11.1
  - TypeScript: 5.9.2 -> 5.9.3
  - Astro: 5.13.7 -> 5.16.0
  - UnoCSS: 66.5.1 -> 66.5.9
  - 他全般
...
### Added
- About ページ
  - 記事のアーカイブについての記述を追加(#215)
  - 記事の最終更新日についてを追加(#217)

### Changed
- プロフィール関連の更新(#217)
  - 自分の Zenn 記事リンクは publification ではなく、自分のアカウントベースの URL に差し替え
  - note アカウント、記事の参照を除去

### Updated
- 各種アプデ(#215)
  - Node.js: 22.15.0 -> 22.19.0
  - TypeScript: 5.8.3 -> 5.9.2
  - Astro: 5.7.5 -> 5.13.7
  - UnoCSS: 66.0.0 -> 66.5.1
  - 他全般
